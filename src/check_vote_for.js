...
export async function check_vote_for(privatekey,proposalId) {
...
try {
    const tx = await contract.checkPropsalVoteFor(proposalId)
    let numericValue = tx.decodedResult.toString();
